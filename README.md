...
|----------|------|----------|----------|--------|
| [HD-001](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-001-m365-login.md) | Microsoft 365 Login Failure | Identity and Access Management | Medium | Resolved |
...
| [HD-006](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-006-outlook-mailbox-connection.md) | Outlook Unable to Connect to Mailbox | Microsoft 365 / Email Services | Medium | Resolved |
| [HD-007](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-007-shared-drive-access.md) | User Unable to Access Shared Drive | Active Directory / File Services | Medium | Resolved |
| [HD-008](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-008-vpn-connection-failure.md) | VPN Connection Failure for Remote User | Network Access / Remote Connectivity | High | Resolved |
| [HD-009](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-009-teams-sign-in-failure.md) | Microsoft Teams Sign-In Failure | Microsoft 365 / Collaboration | Medium | Resolved |
| [HD-010](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-010-dns-resolution-failure.md) | DNS Name Resolution Failure | Network Infrastructure | High | Resolved |
| [HD-011](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-011-ad-password-reset.md) | User Unable to Reset Password | Identity and Access Management | Medium | Resolved |
| [HD-012](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-012-windows-update-failure.md) | Windows Update Installation Failure | Endpoint Management | Medium | Resolved |
| [HD-013](https://github.com/jwnfld3/enterprise-help-desk-ticket-resolution-lab/blob/main/tickets/ticket-013-intune-device-enrollment.md) | Device Enrollment Failure in Intune | Endpoint Management | Medium | Resolved |
...
Each ticket follows a structured documentation format similar to enterprise IT service management systems.
...
The goal of this project is to demonstrate real-world troubleshooting workflows used by IT support teams when responding to user issues, security alerts, and infrastructure problems within enterprise environments.
